                ...
                <div class="relative">
                    <label :for="'checkbox' + <?php echo e($item->id); ?>">
                        ...
                        <div
                            ...
                            <div class="round">
                                <input type="checkbox" :id="'checkbox' + <?php echo e($item->id); ?>" @click="toggleItem(<?php echo e($item->id); ?>)" />
...
<?php echo e($item_category->links()); ?>

<div class="flex justify-center">
    <a @click="createItems()" href="#" class="text-lg text-white flex items-center bg-green-500 border-0 py-2 px-3 focus:outline-none hover:bg-green-800 rounded text-base mt-4 md:mt-0">Create<svg
...
<?php /**PATH D:\Supply Chain\ax-supply-chain\resources\views/livewire/order/apparel.blade.php ENDPATH**/ ?>